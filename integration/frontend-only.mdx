...
description: For developers who have only a frontend â€” Shopify, Webflow, plain HTML, or any site with no custom backend.
---
...
```
Browser (SDK) â†’ Gennoctua Backend â†’ HP AI
```

---

## Step 1 â€” Get your brand key
...
Keep this safe â€” don't share it publicly (though it's safe to use in frontend code, it's tied to your brand's usage limits).
...
document.getElementById("photoInput").addEventListener("change", async (e) => {
  ...
  try {
    ...
    if (summary.availableCategories.length > 0) {
      status.textContent = "âœ“ Ready to try on!";
...
<body>
  ...
  <div id="toggleDiv" style="display:none">
    <button id="toggleBtn">â† Show Original</button>
  </div>
  ...
  <script>
    ...
    document.getElementById("toggleBtn").addEventListener("click", () => {
      ...
      if (showingPersonalized) {
        document.getElementById("resultImg").style.display = "block";
        document.getElementById("productImg").style.display = "none";
        document.getElementById("toggleBtn").textContent = "â† Show Original";
      } else {
        document.getElementById("resultImg").style.display = "none";
        document.getElementById("productImg").style.display = "block";
        document.getElementById("toggleBtn").textContent = "â†’ Show Try-On";
      }
    });
  </script>
</body>
...
<AccordionGroup>
  ...
  <Accordion title='"Personalization timed out"'>
    HP may be under load â€” retry. Check your internet connection.
  </Accordion>
